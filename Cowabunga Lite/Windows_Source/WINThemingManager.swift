...
class WindowsThemingManager {
    static let shared = WindowsThemingManager()
    var currentTheme: String? = nil
    var currentOverlay: String? = nil
    var processing: Bool = false
    var themes: [WindowsThemingManager.Theme] = []
    var overlays: [WindowsThemingManager.Overlay] = []
